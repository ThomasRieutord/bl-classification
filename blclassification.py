...
def blclassification(path_to_dataset,day,linkageStategy="average",metricName="cityblock",normStrategy='meanstd',storeImages=False,fmtImages='.png',figureDir=""):
	...
	X_raw,predictors,interpMethod,z_common,t_common,z_max,Dz,Dt=load_dataset(path_to_dataset,t0=day)
	...
	#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
	plt.figure()
	plt.title(u"Dendrogramme "+day.strftime("%Y/%m/%d"))
...
if __name__=='__main__':
	...
	blclassification(dataDir+datasetname,dt.datetime(2015,2,19),storeImages=storeImages)
